    ...
    >
      ...
      >
        ...
        <div className="flex-1 w-full h-full flex flex-col">
          ...
          {currentScreen === 'auth' && (
            <AuthScreen 
              onLogin={() => setCurrentScreen('workspace')} 
              onBack={() => setCurrentScreen('welcome')} 
            />
          )}

          {currentScreen === 'workspace' && (
            <WorkspaceScreen onLogout={() => setCurrentScreen('welcome')} />
          )}
        </div>
      </div>
